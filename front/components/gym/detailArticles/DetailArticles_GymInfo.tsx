        ...
        <div className={cls.mainContent}>
          <div className={cls.eachContent}>
            <div className={cls.flex}>
              ...
              <div className={cls.Right}>{props.gymInfo.address[0].val}</div>
            </div>

            <div className={cls.flex}>
              <div className={cls.Left}>도로명주소</div>
              <div className={cls.Right}>{props.gymInfo.address[1].val}</div>
            </div>

            <div className={cls.flex}>
              <div className={cls.Left}>지번주소</div>
              <div className={cls.Right}>{props.gymInfo.address[2].val}</div>
            </div>

            <div className={cls.flex}>
              <div className={cls.Left}>상세주소</div>
              <div className={cls.Right}>{props.gymInfo.address[3].val}</div>
            </div>

            <div className={cls.flex}>
              <div className={cls.Left}>참고정보</div>
              <div className={cls.Right}>{props.gymInfo.address[4].val}</div>
            </div>
          </div>
        </div>
